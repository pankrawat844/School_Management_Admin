...
class LeaveActivity : AppCompatActivity(), KodeinAware, LeaveListener,
    PhotoPickerFragment.Callback {
    lateinit var sharedPreferences: SharedPreferences
    override val kodein by kodein()

    val factory: LeaveViewmodelFactory by instance()
    var viewmodel: LeaveViewmodel? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_leave)

        viewmodel = ViewModelProviders.of(this, factory).get(LeaveViewmodel::class.java)
